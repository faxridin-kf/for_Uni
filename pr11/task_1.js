document.write("Подготовил Кучкаров Фахриддин группы 618-21", "<br>");
document.write(
  "На тему: 11.	Дек заполнен случайным образом целыми числами. Найти в деке максимальный и минимальный элементы и поменять их местами.",
  "<br>"
);
